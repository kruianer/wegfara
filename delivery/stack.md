...
| Gast | Jemand, der eine Reise nur mitlesen soll — der Nachbar, der die Route sehen will, der Verwandte, der auf die Reise wartet (req-038). Er hat kein Konto, keinen Passkey und keine Kennzeichnung; er sieht Plan, Programmpunkte und POIs genau einer Reise und kann nichts anlegen, ändern oder löschen. Nicht mit dem Teilnehmer zu verwechseln, der ein eigenes Konto hat. |
| Gastzugang | Was der Reiseleiter einem Gast gibt (req-038): ein befristeter Link — auch als QR-Code — zu genau einer Reise, nur lesend. Er trägt einen Zweck, gilt zwischen einer Stunde und höchstens 90 Tagen (voreingestellt 7) und ist jederzeit widerrufbar; der Widerruf wirkt sofort, auch für eine laufende Gast-Sitzung. Gespeichert wird nur seine Prüfsumme, gezeigt wird er genau einmal. Nicht mit dem Zugangslink zu verwechseln, der eine Person dauerhaft in die App holt. |
