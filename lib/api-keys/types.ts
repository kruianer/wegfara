 ...
 * als Grund und verweist auf die Einstellungen (req-028).
 */
export function apiKeyMissingHint(kind: ApiKeyKind): string {
  return `Für „${API_KEY_LABEL[kind]}“ ist kein Zugangsschlüssel hinterlegt. Ein Account-Admin hinterlegt ihn unter „Einstellungen“.`;
}
